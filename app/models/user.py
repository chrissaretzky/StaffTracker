...
class User(UserMixin, db.Model):
    ...
    change_pw = db.Column(db.Boolean)
    active = db.Column(db.Boolean, default=True)
    start_date = db.Column(db.Date)
    term_date = db.Column(db.Date)
    schedules = db.relationship('User_schedule', backref='user')
    payrolls = db.relationship('User_payroll', backref='user')
